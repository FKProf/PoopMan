...
public class GameOverlay
{
                                ...
                                int selected, float pulse)
    {
        ...
        DrawTextCentered(sb, "SCEGLI UN POTENZIAMENTO", cx, titleY, Color.Gold, 1.6f);
        DrawTextCentered(sb, "< > o frecce  |  ENTER per confermare",
            cx, titleY + 36, new Color(180, 180, 180), 0.80f);
        ...
        for (int i = 0; i < options.Count; i++)
        {
            ...
            DrawTextCentered(sb, opt.Name, nameCx, cardY + 38,
                sel ? opt.Color * pulseMul : Color.White, sel ? 1.25f : 1.05f);
            ...
            foreach (var line in lines)
            {
                DrawTextCentered(sb, line, nameCx, descY,
                    sel ? Color.White : new Color(170, 170, 190), 0.82f);
                descY += 24;
            }
