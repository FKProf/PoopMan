...
internal static class MinerUpgradeDescriptions
{
    ...
    internal static readonly MinerUpgradeEntry[] Standard =
    {
        ...
        new("DETONATORE", "SPECIALE", new Color(255, 99, 71), "ATTIVA",
            "Detonatore remoto: fai esplodere quando vuoi tutte le bombe piazzate (tasto C o Y sul gamepad).",
            new[] { "Lv 1: C / Y = esplosione immediata di tutte le bombe", "Le bombe esplodono comunque a fine miccia" }, 1),
